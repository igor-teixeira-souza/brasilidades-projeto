...
const athletes = [
  { name: "Pelé", image: "/img/pele_b109b2f9f8.png", description: "Considerado o maior jogador de futebol de todos os tempos, Pelé levou o Brasil ao topo do mundo e inspirou gerações.", sport: "futebol" },
  { name: "Marta", image: "/img/marta.png.png", description: "Rainha do futebol feminino, recordista de prêmios da FIFA e símbolo de força feminina no esporte.", sport: "futebol" },
  { name: "Ronaldinho Gaúcho", image: "/img/ronaldinho.png", description: "O Bruxo do futebol, conhecido por sua magia com a bola e jogadas geniais que encantaram o mundo.", sport: "futebol" },
  { name: "Ayrton Senna", image: "/img/senna.png.png", description: "Tricampeão mundial de Fórmula 1, símbolo de determinação, coragem e amor ao Brasil.", sport: "outros" },
  { name: "Gabi Guimarães", image: "/img/gabi.png.png", description: "Destaque do vôlei brasileiro, reconhecida por sua liderança, técnica apurada e conquistas pela seleção nacional.", sport: "volei" },
  { name: "Giba", image: "/img/giba.png.png", description: "Líder da geração de ouro do vôlei brasileiro, campeão olímpico e tricampeão mundial.", sport: "volei" },
  { name: "Sheila Castro", image: "/img/sheila.png", description: "Uma das maiores opostas do vôlei mundial, medalhista olímpica e múltipla campeã mundial.", sport: "volei" },
  { name: "Daniel Dias", image: "/img/daniel-dias.png.jpg", description: "Maior nadador paralímpico brasileiro, símbolo de superação e inspiração com múltiplas medalhas mundiais e olímpicas.", sport: "outros" },
  { name: "Anderson Silva", image: "/img/anderson-silva.png.png", description: "Lenda do MMA, ex-campeão do UFC e referência mundial em técnica e determinação.", sport: "outros" },
  { name: "Isaquias Queiroz", image: "/img/isaquias.png", description: "Maior canoísta brasileiro, tricampeão mundial e medalhista olímpico múltiplo.", sport: "outros" },
  { name: "Arthur Zanetti", image: "/img/zanetti.png", description: "Primeiro brasileiro campeão olímpico na ginástica artística, especialista nas argolas.", sport: "outros" },
  { name: "Daiane dos Santos", image: "/img/daiane.png", description: "Pioneira da ginástica brasileira, primeira campeã mundial e criadora do movimento 'Dos Santos'.", sport: "outros" }
];
  ...
  futebol: [
    {
      ...
      image: "https://via.placeholder.com/350x200/002776/FFFFFF?text=Carlos+Santana",
      description: "Conhecido como 'Cyborg do Futebol', Santana é um dos rivais mais formidáveis de Tsubasa Ozora. Representa a técnica e habilidade brasileira em seu mais alto nível.",
      abilities: ["Chute Potente", "Controle de Bola", "Visão de Jogo", "Dribles Técnicos"],
      position: "Atacante",
      team: "São Paulo FC (anime)",
      rating: 5,
      details: { origem: "Brasil", especialidade: "Finalização", caracteristica: "Frieza técnica em campo" }
    },
    {
      name: "Lavinho",
      anime: "Blue Lock",
      image: "https://via.placeholder.com/350x200/009739/FFFFFF?text=Lavinho",
      description: "Um dos 'Cinco Craques Mundiais', Lavinho é conhecido por seu estilo de jogo livre e cheio de ginga. Ele personifica o futebol arte brasileiro.",
      abilities: ["Ginga", "Dribles Criativos", "Velocidade", "Improvisação"],
      position: "Atacante",
      team: "Seleção Brasileira (Blue Lock)",
      rating: 5,
      details: { origem: "Brasil", especialidade: "Dribles e criatividade", caracteristica: "Estilo livre e imprevisível" }
    },
    {
      name: "Rodrigo",
      anime: "Hungry Heart: Wild Striker",
      image: "https://via.placeholder.com/350x200/002776/FFFFFF?text=Rodrigo",
      description: "Atacante brasileiro que se muda para o Japão em busca de oportunidades. Mostra a garra e determinação típicas dos jogadores brasileiros.",
      abilities: ["Finalização", "Força Física", "Determinação", "Chute de Longa Distância"],
      position: "Atacante",
      team: "Japão (no anime)",
      rating: 4,
      details: { origem: "Brasil", especialidade: "Finalização", caracteristica: "Garra e determinação" }
    },
    {
      name: "Falcão da Silva",
      anime: "Inazuma Eleven",
      image: "https://via.placeholder.com/350x200/009739/FFFFFF?text=Falcão+da+Silva",
      description: "Capitão da Seleção Brasileira 'O Reino' em Inazuma Eleven. Conhecido por suas técnicas especiais e liderança em campo.",
      abilities: ["Técnicas Especiais", "Liderança", "Chutes Poderosos", "Estratégia"],
      position: "Meio-campo",
      team: "O Reino (Brasil)",
      rating: 5,
      details: { origem: "Brasil", especialidade: "Técnicas especiais", caracteristica: "Liderança carismática" }
    },
    {
      name: "Arthur",
      anime: "Inazuma Eleven",
      image: "https://via.placeholder.com/350x200/002776/FFFFFF?text=Arthur+IE+Orion",
      description: "Outro destaque da seleção brasileira 'O Reino', Arthur complementa Falcão com sua técnica apurada e visão de jogo excepcional.",
      abilities: ["Visão de Jogo", "Passes Precisos", "Controle de Meio", "Técnica"],
      position: "Meio-campo",
      team: "O Reino (Brasil)",
      rating: 4,
      details: { origem: "Brasil", especialidade: "Construção de jogadas", caracteristica: "Elegância técnica" }
    },
    {
      name: "Pelé (Referência)",
      anime: "Blue Lock",
      image: "https://via.placeholder.com/350x200/009739/FFFFFF?text=Pelé+Referência",
      description: "A lenda do futebol mundial é frequentemente referenciada em Blue Lock como o padrão de excelência e inspiração para todos os jogadores.",
      abilities: ["Inspiração", "Lenda Viva", "Referência Máxima", "Excelência"],
      position: "Lenda",
      team: "Seleção Brasileira (Histórica)",
      rating: 5,
      details: { origem: "Brasil", especialidade: "Inspiração máxima", caracteristica: "Lenda do futebol mundial" }
    },
  ],
  volei: [
    {
      ...
      anime: "Haikyuu!!",
      image: "https://via.placeholder.com/350x200/002776/FFFFFF?text=Nicollas+Romero",
      description: "Jogador brasileiro de vôlei que atua como oposto. Conhecido por sua experiência internacional e habilidades técnicas refinadas.",
      abilities: ["Ataque Poderoso", "Experiência", "Fundamentos Sólidos", "Blocos"],
      position: "Oposto",
      team: "MSBY Black Jackals",
      rating: 5,
      details: { origem: "Brasil", especialidade: "Ataque e experiência", caracteristica: "Profissionalismo internacional" }
    },
    {
      name: "Heitor",
      anime: "Haikyuu!!",
      image: "https://via.placeholder.com/350x200/009739/FFFFFF?text=Heitor+Haikyuu",
      description: "Jogador brasileiro que aparece brevemente em Haikyuu!!, representando a força do vôlei brasileiro no cenário internacional.",
      abilities: ["Força Física", "Potência", "Fundamentos", "Experiência"],
      position: "Central",
      team: "Seleção Brasileira (anime)",
      rating: 4,
      details: { origem: "Brasil", especialidade: "Bloqueio e força", caracteristica: "Físico imponente" }
    }
  ]
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  setTimeout(() => {
    try {
      ...
      console.log(`🎌 ${animeCharacters.futebol.length + animeCharacters.volei.length} personagens de anime carregados`);
...
function showSuggestions(searchTerm) {
  ...
  const matchingAthletes = athletes.filter(athlete => 
  ...
  if (matchingAthletes.length === 0) {
    ...
    noResults.innerHTML = '<span class="suggestion-name">Nenhum atleta encontrado</span>';
    ...
    matchingAthletes.forEach(athlete => {
      ...
      switch(athlete.sport) {
        case 'futebol': sportText = '⚽ Futebol'; break;
        case 'volei': sportText = '🏐 Vôlei'; break;
        default: sportText = '🏅 Outros';
      }
...
function handleSearchNavigation(e) {
  const suggestionsContainer = document.getElementById('search-suggestions');
  const suggestions = suggestionsContainer ? suggestionsContainer.querySelectorAll('.search-suggestion') : [];
  ...
  switch(e.key) {
    ...
    case 'Enter':
      ...
      if (currentSuggestionIndex >= 0 && currentSuggestionIndex < suggestions.length) {
        const athleteName = suggestions[currentSuggestionIndex].getAttribute('data-athlete-name');
...
function selectSuggestion(athleteName) {
  ...
  if (searchInput) {
    ...
    const athleteIndex = filteredAthletes.findIndex(athlete => 
...
function createAnimeCards() {
  ...
  if (futebolGrid) {
    ...
    console.log(`✅ ${animeCharacters.futebol.length} cards de futebol criados`);
  } else {
...
function createAnimeCard(character) {
  ...
  card.setAttribute('aria-label', `Personagem: ${character.name} do anime ${character.anime}`);
  
  const stars = '★'.repeat(character.rating) + '☆'.repeat(5 - character.rating);
  
  card.innerHTML = `
    <div class="anime-card-header">
      <img src="${character.image}" alt="${character.name}" class="anime-card-image" />
      <div class="anime-card-badge">${character.anime}</div>
    </div>
    <div class="anime-card-content">
      <h4 class="anime-card-title">${character.name}</h4>
      <p class="anime-card-subtitle">${character.position} • ${character.team}</p>
...
function initInstructionsModal() {
  ...
  const hasSeenInstructions = localStorage.getItem('brasilidades-instructions-seen');
  ...
  document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape' && instructionsModal.classList.contains('is-active')) {
...
function setupAccessibility() {
  ...
  if (increaseFontButton) {
    increaseFontButton.addEventListener('click', function() {
      ...
      localStorage.setItem('fontSize', body.classList.contains('xlarge-font') ? 'xlarge' : 
        body.classList.contains('large-font') ? 'large' : 'normal');
    });
  }

  if (decreaseFontButton) {
    decreaseFontButton.addEventListener('click', function() {
      if (!body.classList.contains('large-font') && !body.classList.contains('xlarge-font')) return;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (athleteModal) {
    athleteModal.querySelector('.modal-close').addEventListener('click', closeModal);
    athleteModal.querySelector('.modal-background').addEventListener('click', closeModal);
  }
